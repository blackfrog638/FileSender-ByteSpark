...
| 1 | XT-022 | native_core | protected identity and pairing-record storage | XT-018 |
...
Security ordering is fail-closed: XT-025 cannot start until XT-024 accepts both
the protected identity and TLS providers. Public C ABI work is serialized
through XT-021, XT-026, XT-030, and XT-037. ADR 0008 governs that additive
surface. No task before XT-032 may claim the vertical slice, and no task before
XT-039 may claim production P1 behavior.
