...
contract_changes:
  - The canonical repository identity is chenzhuoran
...
Restore `chenzhuoran <chenzhuoran.638@bytedance.com>` as the canonical
...
`blackfrog638 <blackfrog638@gmail.com>` as canonical, reversing the previously
...
- [ ] The schema v2 policy names `chenzhuoran
      <chenzhuoran.638@bytedance.com>`.
