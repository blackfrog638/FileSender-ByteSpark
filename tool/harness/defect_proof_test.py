...
class DefectProofTest(unittest.TestCase):
    ...
    def write_script(self, exit_code: int) -> None:
    ...
    def test_records_failure_at_reproduction_and_pass_at_head(self) -> None:
        _, reproduction, head = self.create_history(1, 0)
